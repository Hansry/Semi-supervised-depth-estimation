...
class Result(object):
    ...
    def update(self, irmse, imae, mse, rmse, mae, absrel, squared_rel, lg10, \
            delta1, delta2, delta3, gpu_time, data_time, silog, photometric=0, covisualmetric=0):
        self.irmse = irmse
        self.imae = imae
        self.mse = mse
        self.rmse = rmse
        ...
        self.covisualmetric = covisualmetric

    def evaluate(self, output, target, photometric=0, covisualmetric=0):
        ...
        self.covisualmetric = float(covisualmetric)
...
class AverageMeter(object):
    ...
    def update(self, result, gpu_time, data_time, n=1):
        ...
        self.sum_covisualmetric += n*result.covisualmetric
    ...
    def average(self):
        ...
        if self.count > 0:
            avg.update(
                ...
                self.sum_covisualmetric / self.count
                )
        return avg
