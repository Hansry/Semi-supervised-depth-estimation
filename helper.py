    ...
    def conditional_print(self,split,i,epoch,lr,n_set,blk_avg_meter,avg_meter):
        if (i + 1) % self.args.print_freq == 0:
            ...
            print('{split} Epoch: {0} [{1}/{2}]\tlr={lr} '
                  ...
                  'Covisualmetric={blk_avg.covisualmetric:.3f}({average.covisualmetric:.3f})'.format(
...
def get_folder_name(args):
    ...
    if args.use_pose:
        prefix = "mode={}.w1={}.w2={}.w3={}.".format(args.train_mode, args.w1, args.w2, args.w3)
    else:
        prefix = "mode={}.".format(args.train_mode)
    return os.path.join(args.result,
        prefix + 'resnet{}.criterion={}.lr={}.bs={}.wd={}.pretrained={}.jitter={}.time={}'.
